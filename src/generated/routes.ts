...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { SecureController } from './../routes/secure';
...
const models: TsoaRoute.Models = {
    ...
    "UserFromGroup": {
        ...
        "properties": {
            ...
            "groupId": {"dataType":"integer","required":true,"validators":{"isInt":{"errorMsg":"we would kindly ask you to provide a number here"}}},
        },
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/users/:groupId/all',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.getUsers)),

            async function UserController_getUsers(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    groupId: {"in":"path","name":"groupId","required":true,"dataType":"integer","validators":{"isInt":{"errorMsg":"This message will show if the validation fails"}}},
                    limit: {"in":"query","name":"limit","dataType":"integer","validators":{"isInt":{"errorMsg":"This message will show if the validation fails"}}},
            };
        ...
        app.get('/secure',
            ...
            async function SecureController_getTreasure(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
